...
function show(button_element) {
    ...
    */
    ...
    let fun_fact = document.getElementById("ta-fun-fact")
    let photo = document.getElementById("ta-photo")
    ...
    let id = button_element.id
    let fact = facts[id]

    fun_fact.innerText = fact
    ...
    for (ta in facts){
        btn = document.getElementById(ta)
        if (ta != button_element.id) {
